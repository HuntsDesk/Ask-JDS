        ...
        <section id="top" className="pt-16 pb-16 md:pt-20 md:pb-24 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-4 box-border relative z-10">
            ...
            <div className="text-center mt-16">
              ...
              Here for your panic sessions, bar meltdowns, and when you forget the rule against perpetuities (again).
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="col-span-1 md:col-span-2">
              ...
              <div className="flex space-x-4">
                <a href="https://www.youtube.com/@JDsimplified" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition-colors" aria-label="YouTube">
