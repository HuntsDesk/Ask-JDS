...
BEGIN
  ...
  RAISE NOTICE 'User is admin: %', public.is_admin(auth.uid());
...
CREATE POLICY "Admin users can delete any collection_subjects" ON "public"."collection_subjects" FOR DELETE TO "authenticated" USING (( SELECT "public"."is_admin"("auth"."uid"()) AS "is_admin"));



CREATE POLICY "Admin users can delete any flashcard_collections_junction" ON "public"."flashcard_collections_junction" FOR DELETE TO "authenticated" USING (( SELECT "public"."is_admin"("auth"."uid"()) AS "is_admin"));



CREATE POLICY "Admin users can delete any flashcard_exam_types" ON "public"."flashcard_exam_types" FOR DELETE TO "authenticated" USING (( SELECT "public"."is_admin"("auth"."uid"()) AS "is_admin"));



CREATE POLICY "Admin users can delete any flashcard_subjects" ON "public"."flashcard_subjects" FOR DELETE TO "authenticated" USING (( SELECT "public"."is_admin"("auth"."uid"()) AS "is_admin"));



CREATE POLICY "Admin users can insert any collection_subjects" ON "public"."collection_subjects" FOR INSERT TO "authenticated" WITH CHECK (( SELECT "public"."is_admin"("auth"."uid"()) AS "is_admin"));



CREATE POLICY "Admin users can insert any flashcard_collections_junction" ON "public"."flashcard_collections_junction" FOR INSERT TO "authenticated" WITH CHECK (( SELECT "public"."is_admin"("auth"."uid"()) AS "is_admin"));



CREATE POLICY "Admin users can insert any flashcard_exam_types" ON "public"."flashcard_exam_types" FOR INSERT TO "authenticated" WITH CHECK (( SELECT "public"."is_admin"("auth"."uid"()) AS "is_admin"));



CREATE POLICY "Admin users can update any collection_subjects" ON "public"."collection_subjects" FOR UPDATE TO "authenticated" USING (( SELECT "public"."is_admin"("auth"."uid"()) AS "is_admin")) WITH CHECK (( SELECT "public"."is_admin"("auth"."uid"()) AS "is_admin"));



CREATE POLICY "Admin users can update any flashcard_collections_junction" ON "public"."flashcard_collections_junction" FOR UPDATE TO "authenticated" USING (( SELECT "public"."is_admin"("auth"."uid"()) AS "is_admin")) WITH CHECK (( SELECT "public"."is_admin"("auth"."uid"()) AS "is_admin"));



CREATE POLICY "Admin users can update any flashcard_exam_types" ON "public"."flashcard_exam_types" FOR UPDATE TO "authenticated" USING (( SELECT "public"."is_admin"("auth"."uid"()) AS "is_admin")) WITH CHECK (( SELECT "public"."is_admin"("auth"."uid"()) AS "is_admin"));



CREATE POLICY "Admin users can update any flashcard_subjects" ON "public"."flashcard_subjects" FOR UPDATE TO "authenticated" USING (( SELECT "public"."is_admin"("auth"."uid"()) AS "is_admin")) WITH CHECK (( SELECT "public"."is_admin"("auth"."uid"()) AS "is_admin"));



CREATE POLICY "Admins can create course-subject relationships" ON "public"."course_subjects" FOR INSERT TO "authenticated" WITH CHECK ("public"."is_admin"());



CREATE POLICY "Admins can delete course-subject relationships" ON "public"."course_subjects" FOR DELETE TO "authenticated" USING ("public"."is_admin"());
...
CREATE POLICY "Admins can manage all courses" ON "public"."courses" USING ("public"."is_admin"()) WITH CHECK ("public"."is_admin"());



CREATE POLICY "Admins can manage all enrollments" ON "public"."course_enrollments" USING ("public"."is_admin"()) WITH CHECK ("public"."is_admin"());



CREATE POLICY "Admins can manage all lessons" ON "public"."lessons" USING ("public"."is_admin"()) WITH CHECK ("public"."is_admin"());



CREATE POLICY "Admins can manage all modules" ON "public"."modules" USING ("public"."is_admin"()) WITH CHECK ("public"."is_admin"());



CREATE POLICY "Admins can manage system prompts" ON "public"."system_prompts" USING ("public"."is_admin"());
...
CREATE POLICY "Admins can update course-subject relationships" ON "public"."course_subjects" FOR UPDATE TO "authenticated" USING ("public"."is_admin"()) WITH CHECK ("public"."is_admin"());
...
CREATE POLICY "Admins can view all subscriptions" ON "public"."user_subscriptions" FOR SELECT TO "authenticated" USING (( SELECT "public"."is_admin"("auth"."uid"()) AS "is_admin"));
...
CREATE POLICY "Only admins can manage exam types" ON "public"."exam_types" TO "authenticated" USING ("public"."is_admin"());



CREATE POLICY "Only admins can view error logs" ON "public"."error_logs" FOR SELECT USING ("public"."is_admin"());



CREATE POLICY "Only admins can view query logs" ON "public"."query_logs" FOR SELECT TO "authenticated" USING ("public"."is_admin"());
...
CREATE POLICY "Users can insert flashcard-subject associations" ON "public"."flashcard_subjects" FOR INSERT TO "authenticated" WITH CHECK ((( SELECT "public"."is_admin"("auth"."uid"()) AS "is_admin") OR (EXISTS ( SELECT 1
...
CREATE POLICY "models_access" ON "public"."models" TO "authenticated" USING (("public"."is_admin"() OR ("is_public" = true)));
