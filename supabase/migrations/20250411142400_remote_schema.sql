...
CREATE OR REPLACE FUNCTION "public"."has_course_access"("p_user_id" "uuid", "p_course_id" "uuid") RETURNS boolean
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
  DECLARE
  ...
  BEGIN
    ...
    SELECT (price = 0 OR price IS NULL) INTO is_free_course FROM courses WHERE id = p_course_id;
    
    IF is_free_course THEN
      RETURN TRUE;
    END IF;
    
    -- Individual enrollment check with grace period (4 hours)
    SELECT EXISTS (
      SELECT 1 FROM course_enrollments 
      WHERE user_id = p_user_id 
      AND course_id = p_course_id 
      AND expires_at + interval '4 hours' > now()
      AND status = 'active'
    ...
    -- Unlimited subscription check with same grace period
    SELECT EXISTS (
      SELECT 1 FROM user_subscriptions
      WHERE user_id = p_user_id
      AND status = 'active'
      AND current_period_end + interval '4 hours' > now()
      AND tier = 'unlimited'
    ) INTO has_unlimited_access;
    
    RETURN has_unlimited_access;
  END;
  $$;


ALTER FUNCTION "public"."has_course_access"("p_user_id" "uuid", "p_course_id" "uuid") OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."course_enrollments" (
    ...
    "source" "text" DEFAULT 'direct_purchase'::"text",
    "transaction_id" "text",
...
CREATE TABLE IF NOT EXISTS "public"."courses" (
    ...
    "sample_video_1_id" "text",
    "sample_video_1_title" "text",
    "sample_video_2_id" "text",
    "sample_video_2_title" "text",
    "sample_video_3_id" "text",
    "sample_video_3_title" "text",
...
CREATE OR REPLACE VIEW "public"."schema_overview" AS
 WITH "schema_data" AS (
         SELECT "public"."get_database_schema"() AS "schema"
        ), "table_info" AS (
         SELECT "t"."key" AS "table_name",
            ("t"."value" -> 'columns'::"text") AS "columns",
            COALESCE(( SELECT "jsonb_agg"("policy_key"."policy_key") AS "jsonb_agg"
                   FROM "schema_data" "s_1",
                    LATERAL "jsonb_object_keys"(("s_1"."schema" -> 'policies'::"text")) "policy_key"("policy_key")
                  WHERE ("policy_key"."policy_key" ~~ ("t"."key" || '.%'::"text"))
                  GROUP BY "t"."key"), '[]'::"jsonb") AS "policies",
            COALESCE(( SELECT "jsonb_agg"("constraint_key"."constraint_key") AS "jsonb_agg"
                   FROM "schema_data" "s_1",
                    LATERAL "jsonb_object_keys"(("s_1"."schema" -> 'constraints'::"text")) "constraint_key"("constraint_key")
                  WHERE ("constraint_key"."constraint_key" ~~ ("t"."key" || '.%'::"text"))
                  GROUP BY "t"."key"), '[]'::"jsonb") AS "constraints"
           FROM "schema_data" "s",
            LATERAL "jsonb_each"(("s"."schema" -> 'tables'::"text")) "t"("key", "value")
        )
...
COMMENT ON VIEW "public"."schema_overview" IS 'Provides a simplified overview of tables with their columns, policies, and constraints';
...
CREATE TABLE IF NOT EXISTS "public"."user_subscriptions" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "tier" "text" DEFAULT 'askjds'::"text" NOT NULL,
    "price_id" "text",
    "previous_tier" "text",
...
CREATE INDEX "idx_course_enrollments_user_expires" ON "public"."course_enrollments" USING "btree" ("user_id", "expires_at");
...
CREATE UNIQUE INDEX "idx_webhook_events_processed" ON "public"."webhook_events" USING "btree" ("event_id") WHERE ("status" = 'processed'::"text");
...
ALTER TABLE ONLY "public"."course_enrollments"
    ADD CONSTRAINT "course_enrollments_last_updated_by_fkey" FOREIGN KEY ("last_updated_by") REFERENCES "auth"."users"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."user_subscriptions"
    ADD CONSTRAINT "user_subscriptions_last_updated_by_fkey" FOREIGN KEY ("last_updated_by") REFERENCES "auth"."users"("id") ON DELETE SET NULL;
...
CREATE POLICY "Admin users can delete any collection_subjects" ON "public"."collection_subjects" FOR DELETE TO "authenticated" USING (((("auth"."jwt"() -> 'user_metadata'::"text") ->> 'is_admin'::"text") = 'true'::"text"));



CREATE POLICY "Admin users can delete any flashcard_collections_junction" ON "public"."flashcard_collections_junction" FOR DELETE TO "authenticated" USING (((("auth"."jwt"() -> 'user_metadata'::"text") ->> 'is_admin'::"text") = 'true'::"text"));



CREATE POLICY "Admin users can delete any flashcard_exam_types" ON "public"."flashcard_exam_types" FOR DELETE TO "authenticated" USING (((("auth"."jwt"() -> 'user_metadata'::"text") ->> 'is_admin'::"text") = 'true'::"text"));



CREATE POLICY "Admin users can delete any flashcard_subjects" ON "public"."flashcard_subjects" FOR DELETE TO "authenticated" USING (((("auth"."jwt"() -> 'user_metadata'::"text") ->> 'is_admin'::"text") = 'true'::"text"));



CREATE POLICY "Admin users can insert any collection_subjects" ON "public"."collection_subjects" FOR INSERT TO "authenticated" WITH CHECK (((("auth"."jwt"() -> 'user_metadata'::"text") ->> 'is_admin'::"text") = 'true'::"text"));



CREATE POLICY "Admin users can insert any flashcard_collections_junction" ON "public"."flashcard_collections_junction" FOR INSERT TO "authenticated" WITH CHECK (((("auth"."jwt"() -> 'user_metadata'::"text") ->> 'is_admin'::"text") = 'true'::"text"));



CREATE POLICY "Admin users can insert any flashcard_exam_types" ON "public"."flashcard_exam_types" FOR INSERT TO "authenticated" WITH CHECK (((("auth"."jwt"() -> 'user_metadata'::"text") ->> 'is_admin'::"text") = 'true'::"text"));



CREATE POLICY "Admin users can insert any flashcard_subjects" ON "public"."flashcard_subjects" FOR INSERT TO "authenticated" WITH CHECK (((("auth"."jwt"() -> 'user_metadata'::"text") ->> 'is_admin'::"text") = 'true'::"text"));



CREATE POLICY "Admin users can update any collection_subjects" ON "public"."collection_subjects" FOR UPDATE TO "authenticated" USING (((("auth"."jwt"() -> 'user_metadata'::"text") ->> 'is_admin'::"text") = 'true'::"text"));



CREATE POLICY "Admin users can update any flashcard_collections_junction" ON "public"."flashcard_collections_junction" FOR UPDATE TO "authenticated" USING (((("auth"."jwt"() -> 'user_metadata'::"text") ->> 'is_admin'::"text") = 'true'::"text"));



CREATE POLICY "Admin users can update any flashcard_exam_types" ON "public"."flashcard_exam_types" FOR UPDATE TO "authenticated" USING (((("auth"."jwt"() -> 'user_metadata'::"text") ->> 'is_admin'::"text") = 'true'::"text"));



CREATE POLICY "Admin users can update any flashcard_subjects" ON "public"."flashcard_subjects" FOR UPDATE TO "authenticated" USING (((("auth"."jwt"() -> 'user_metadata'::"text") ->> 'is_admin'::"text") = 'true'::"text"));
...
CREATE POLICY "Admins can view all subscriptions" ON "public"."user_subscriptions" FOR SELECT USING (((("auth"."jwt"() ->> 'role'::"text") = 'service_role'::"text") OR (((("auth"."jwt"() -> 'user_metadata'::"text") ->> 'is_admin'::"text"))::boolean = true)));
...
CREATE POLICY "Users can insert their own flashcard_collections_junction" ON "public"."flashcard_collections_junction" FOR INSERT TO "authenticated" WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."collections" "c"
  WHERE (("c"."id" = "flashcard_collections_junction"."collection_id") AND ("c"."user_id" = "auth"."uid"())))));
...
CREATE POLICY "Users can update flashcards" ON "public"."flashcards" FOR UPDATE TO "authenticated" USING (true) WITH CHECK (true);
...
CREATE POLICY "course_enrollments_select" ON "public"."course_enrollments" FOR SELECT TO "authenticated" USING ((("user_id" = "auth"."uid"()) OR (EXISTS ( SELECT 1
   FROM "public"."profiles"
  WHERE (("profiles"."id" = "auth"."uid"()) AND ("profiles"."is_admin" = true))))));
...
CREATE POLICY "user_subscriptions_select" ON "public"."user_subscriptions" FOR SELECT TO "authenticated" USING ((("user_id" = "auth"."uid"()) OR (EXISTS ( SELECT 1
   FROM "public"."profiles"
  WHERE (("profiles"."id" = "auth"."uid"()) AND ("profiles"."is_admin" = true))))));
...
CREATE POLICY "webhook_events_select" ON "public"."webhook_events" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles"
  WHERE (("profiles"."id" = "auth"."uid"()) AND ("profiles"."is_admin" = true)))));
...
GRANT ALL ON FUNCTION "public"."has_course_access"("p_user_id" "uuid", "p_course_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."has_course_access"("p_user_id" "uuid", "p_course_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."has_course_access"("p_user_id" "uuid", "p_course_id" "uuid") TO "service_role";
