...
-- Note: CREATE INDEX CONCURRENTLY cannot run in transaction blocks
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_course_enrollments_course_id 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_lessons_module_id 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_flashcard_progress_flashcard_id 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_collections_user_id 
