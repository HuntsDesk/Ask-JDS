...
const CtaSection = () => {
  return (
    <section className="bg-gradient-to-br from-jdorange to-jdorange-dark py-16 relative overflow-hidden box-border">
      <div className="max-w-6xl mx-auto px-4 text-center relative box-border">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <Link to="/courses" className="bg-white text-jdorange hover:bg-gray-100 font-medium px-6 py-3 rounded-lg transition-all active:scale-95">
            Browse Courses
          </Link>
